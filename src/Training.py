# Fine tuning of Whisper Large using BitFit adapters for dysarthric speech (Huntington's disease)
...
from utils.models import load_base_model
...
def train(config: TrainingConfig):
    ...
    if best_ckpt is not None:
        shutil.copytree(best_ckpt, f"best_model", dirs_exist_ok=True)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fine-tune Whisper Large with BitFit adapters")
